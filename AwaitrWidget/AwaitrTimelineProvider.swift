...
struct AwaitrTimelineProvider: TimelineProvider {

    // MARK: - Placeholder

    func placeholder(in context: Context) -> AwaitrWidgetEntry {
        .placeholder
    }

    // MARK: - Snapshot

    func getSnapshot(in context: Context, completion: @escaping (AwaitrWidgetEntry) -> Void) {
    ...
    func getTimeline(in context: Context, completion: @escaping (Timeline<AwaitrWidgetEntry>) -> Void) {
    ...
    private func fetchEntry() -> AwaitrWidgetEntry {
        do {
