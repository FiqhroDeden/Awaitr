...
- [ ] **2.1** Bug fixes from user feedback
- [ ] **2.2** Accessibility audit — VoiceOver labels, Dynamic Type support, contrast ratios
- [ ] **2.3** Haptic feedback on status transitions and key interactions
- [ ] **2.4** Improved empty states — helpful onboarding when no items exist
- [ ] **2.5** Performance profiling — ensure smooth 60fps animations
- [ ] **2.6** Localization — Bahasa Indonesia (home market first)
...
- [ ] **3.1** Home Screen Widget (WidgetKit) — show active items count + nearest deadline
- [ ] **3.2** iPad support — adaptive layout
- [ ] **3.3** Search & filter improvements
- [ ] **3.4** Improved charts/analytics in Archive
- [ ] **3.5** App icon alternatives (Settings picker)
- [ ] **3.6** Submit v1.1 to App Store
- [ ] **3.7** Submit new featuring nomination (type: "App Enhancements")
